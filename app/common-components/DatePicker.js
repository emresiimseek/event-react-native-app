...
export default function DatePicker(props) {
    const { type, placeHolder = "Seçiniz", dateSelected, validations = [], fieldName, } = props;
    ...
    const onChange = (event, selectedDate) => {
        ...
        type == "time" ? setText(moment(currentDate).format('LT')) : setText(moment(currentDate).format('LL'));
    ...
    return (
        <View >
            ...
            {type == "time" ? <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <View style={{ flex: 2, marginRight: 5 }}>
                    <FormInput placeholder={placeHolder} value={text} disabled={true} />
                </View>
                <View style={{ paddingTop: 4 }}>
                    <Button icon="clock-o" color="black" text="Saat Seç" onPress={showTimepicker} />
                </View>
                ...
                <View style={{ paddingTop: 4 }}>
                    <Button icon="calendar" color="black" text="Tarih Seç" onPress={showDatepicker} />
                </View>
